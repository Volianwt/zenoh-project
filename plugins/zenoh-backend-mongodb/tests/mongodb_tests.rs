...
fn test_mongo_backend_put_get() {
    ...
    if !docker_available {
        eprintln!("Skipping mongo_backend_put_get: Docker is not available.");
        return;
    }
...
#[test]
fn test_mongo_backend_delete_removes_data() {
    let docker_available = std::process::Command::new("docker")
        .arg("info")
        .output()
        .map(|output| output.status.success())
...
#[test]
fn test_mongo_backend_round_trip_non_utf8_payload() {
    let docker_available = std::process::Command::new("docker")
        .arg("info")
        .output()
        .map(|output| output.status.success())
...
#[test]
fn test_mongo_backend_rejects_older_timestamp() {
    let docker_available = std::process::Command::new("docker")
        .arg("info")
        .output()
        .map(|output| output.status.success())
...
#[test]
fn test_mongo_backend_put_is_idempotent() {
    let docker_available = std::process::Command::new("docker")
        .arg("info")
        .output()
        .map(|output| output.status.success())
...
#[test]
fn test_mongo_backend_delete_unknown_key() {
    let docker_available = std::process::Command::new("docker")
        .arg("info")
        .output()
        .map(|output| output.status.success())
    ...
    if !docker_available {
        eprintln!("Skipping test_mongo_backend_delete_unknown_key: Docker is not available.");
        return;
    }
...
#[test]
fn test_mongo_backend_get_unknown_key() {
    let docker_available = std::process::Command::new("docker")
        .arg("info")
        .output()
        .map(|output| output.status.success())
    ...
    if !docker_available {
        eprintln!("Skipping test_mongo_backend_get_unknown_key: Docker is not available.");
        return;
    }
